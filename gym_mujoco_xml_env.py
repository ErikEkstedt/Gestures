...
# Path to xml in roboschool instalation path
PATH_TO_XML = "/home/erik/anaconda3/envs/robo/lib/python3.5/site-packages/roboschool/roboschool"
...
class RoboschoolMujocoXmlEnv(gym.Env):
    ...
    def _reset(self):
        ''' changed dump to 1 so its verbose'''
        ...
        self.mjcf = self.scene.cpp_world.load_mjcf(os.path.join(PATH_TO_XML, "mujoco_assets", self.model_xml))
        self.ordered_joints = []
        self.jdict = {}
        self.parts = {}
        self.frame = 0
